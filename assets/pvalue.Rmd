...
We borrow strenght accross proteins by

1. placing a scaled inverse $\chi$^2$ prior: $\chi^2(s_o,\text{df}_0)$ on the variances
2. estimating the prior parameters $s_0$ and $df_0$
3. replacing the protein-wise variances with the maximum a-posteriori
...
$$s_\text{posterior}=\sqrt{\frac{d_p\times S^2_p + d_0 s_0^2}{d_p+d_0}} $$
